...
/*
    This model was downloaded in glb format and converted to jsx using the above tool.
    The original file is available at /public/scene.glb.
    It has been modified slightly for this project:
     - Materials have been renamed to be more descriptive.
     - Some meshes have had their names changed to make them easier to reference.
     - A few meshes have been removed as they were not needed for this project.
*/

// We need to change the path of the scene.glb
...
function IPhone(props) {
  ...
  // the texture is applied to the screen mesh
  useEffect(() => {
